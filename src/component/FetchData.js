...
const FetchData = ({ cat }) => {
  ...
  const fetchData = async () => {
    await axios
      .get(
        cat
          ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=31c910833f5949f6b0fe1f8241c091b2`
          : "https://newsapi.org/v2/top-headlines?country=in&category=general&apiKey=31c910833f5949f6b0fe1f8241c091b2"
      )
      .then((res) => {
  ...
  return (
    <div className="grid bg-green-100 items-center justify-center border p-5 ">
      <h1 className="text-4xl font-bold flex items-center m-auto p-5 underline ">
        {category}
      </h1>
      {Data
